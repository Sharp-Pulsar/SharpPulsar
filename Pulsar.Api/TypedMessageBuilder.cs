...
//ORIGINAL LINE: MessageId send() throws PulsarClientException;
	...
	{
		public const string CONF_KEY = "key";
		public const string CONF_PROPERTIES = "properties";
		public const string CONF_EVENT_TIME = "eventTime";
		public const string CONF_SEQUENCE_ID = "sequenceId";
		public const string CONF_REPLICATION_CLUSTERS = "replicationClusters";
		public const string CONF_DISABLE_REPLICATION = "disableReplication";
		public const string CONF_DELIVERY_AFTER_SECONDS = "deliverAfterSeconds";
		public const string CONF_DELIVERY_AT = "deliverAt";
	}
