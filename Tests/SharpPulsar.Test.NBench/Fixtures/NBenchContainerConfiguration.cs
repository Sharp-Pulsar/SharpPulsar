...
{
    public sealed class NBenchContainerConfiguration : PulsarTestcontainerConfiguration
    {
        public NBenchContainerConfiguration(string image, int port):base(image, port)
        {
        }
