...
{
	public sealed partial class CommandAckResponse : ByteBufCodedOutputStream.ByteBufGeneratedMessage
	{
		// Use CommandAckResponse.newBuilder() to construct.
		internal static ThreadLocalPool<CommandAckResponse> _pool = new ThreadLocalPool<CommandAckResponse>(handle => new CommandAckResponse(handle), 1, true);

		internal ThreadLocalPool.Handle _handle;
		private CommandAckResponse(ThreadLocalPool.Handle handle)
		{
			_handle = handle;
		}
		...
		public CommandAckResponse(bool NoInit)
		{
		}

		
		internal static readonly CommandAckResponse _defaultInstance;
		public static CommandAckResponse DefaultInstance => _defaultInstance;

        public CommandAckResponse DefaultInstanceForType => _defaultInstance;
		...
		{
			// Construct using org.apache.pulsar.common.api.proto.CommandAckResponse.newBuilder()
			...
			public CommandAckResponse DefaultInstanceForType => DefaultInstance;
			...
			public CommandAckResponse BuildParsed()
			{
				CommandAckResponse Result = BuildPartial();
				if (!Result.Initialized)
				{
			...
			{
				CommandAckResponse Result = CommandAckResponse._pool.Take();
		...
		{
			_defaultInstance = new CommandAckResponse(true);
