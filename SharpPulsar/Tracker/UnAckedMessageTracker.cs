...
namespace SharpPulsar.Tracker
{
    public class UnAckedMessageTracker:ReceiveActor
    {
        ...
        private async ValueTask AddChunkedMessageIdsAndRemoveFromSequnceMap(IMessageId messageId, ISet<IMessageId> messageIds)
        {
            ...
            {
                //use ask here
                var chunkedMsgIds = await _consumer.AskFor<UnAckedChunckedMessageIdSequenceMapCmdResponse>(new UnAckedChunckedMessageIdSequenceMapCmd(UnAckedCommand.Get, id));
