...
namespace SharpPulsar.Api
{
	...
	public interface IProducer : IAsyncDisposable
	{
		...
		IMessageId Send(object message);
		...
		ValueTask<IMessageId> SendAsync(object message);
		...
		ITypedMessageBuilder NewMessage();
		...
		ITypedMessageBuilder NewMessage(ISchema schema);
