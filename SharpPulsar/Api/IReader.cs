...
//ORIGINAL LINE: Message<T> readNext(int timeout, java.util.concurrent.TimeUnit unit) throws PulsarClientException;
		...
		/// <exception cref="Exceptions.PulsarClientException"> if there was any error in the operation </exception>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in C#:
//ORIGINAL LINE: boolean hasMessageAvailable() throws PulsarClientException;
		...
		///         <seealso cref="Exceptions.PulsarClientException"/> if there was any error in the operation </returns>
