...
namespace SharpPulsar.Api
{
	...
	/// <summary>
	/// <seealso cref="ReaderBuilder"/> is used to configure and create instances of <seealso cref="Reader{T}"/>.
	/// </summary>
	...
	public interface IReaderBuilder : ICloneable
	{
		...
		/// <seealso cref="IReaderBuilder.startMessageIdInclusive()"/>.
		/// 
		/// </para>
		/// </summary>
		...
		/// on non-persistent topics will lead to the reader create call throwing a <seealso cref="Exceptions.PulsarClientException"/>.
		/// 
		/// </para>
		/// </summary>
