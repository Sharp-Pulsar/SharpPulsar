...
namespace SharpPulsar.Impl.Internal
{
    public sealed class ConsumerStreamFactory : IConsumerStreamFactory
    {
        ...
        public ConsumerStreamFactory(ConnectionPool connectionPool, ConsumerOptions/*Clientconfigurationdata*/ options, IFaultStrategy faultStrategy)
        {
            ...
            _subscribe = new CommandSubscribe
            {
                ...
                Topic = options.Topic,
                subType = (CommandSubscribe.SubType)options.SubscriptionType
