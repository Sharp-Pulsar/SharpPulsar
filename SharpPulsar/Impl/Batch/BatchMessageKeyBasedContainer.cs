...
namespace org.apache.pulsar.client.impl
{
	...
	/// </summary>
	internal class BatchMessageKeyBasedContainer : AbstractBatchMessageContainer
	{
...
//ORIGINAL LINE: private java.util.List<MessageImpl<?>> messages = com.google.common.collect.Lists.newArrayList();
			...
			internal virtual ByteBuf CompressedBatchMetadataAndPayload
			{
				get
				{
	//JAVA TO C# CONVERTER WARNING: Java wildcard generics have no direct equivalent in .NET:
	//ORIGINAL LINE: for (MessageImpl<?> msg : messages)
			...
			internal virtual void addMsg<T1>(MessageImpl<T1> msg, SendCallback callback)
			{
				if (messages.Count == 0)
				{
