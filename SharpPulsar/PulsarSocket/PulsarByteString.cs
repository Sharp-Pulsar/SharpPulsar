...
namespace SharpPulsar.PulsarSocket
{
    ...
    public sealed class PulsarByteString : IEquatable<PulsarByteString>, IEnumerable<byte>
    {
        ...
        /// </summary>
        internal static PulsarByteString FromBuffers(IEnumerator<ByteBuffer> buffers)
        {
        ...
        /// <summary>
        /// Creates a new <see cref="PulsarByteString"/> by copying a provided byte array.
        /// </summary>
        /// <param name="array">Array of bytes to copy</param>
        /// <returns>A byte string representation of array of bytes.</returns>
        public static PulsarByteString CopyFrom(byte[] array) => CopyFrom(array, 0, array.Length);

        /// <summary>
        /// Creates a new <see cref="PulsarByteString"/> by copying a byte array range from provided buffer.
        /// </summary>
        /// <param name="buffer">Buffer specifying a byte array range to copy.</param>
        /// <returns>A byte string representation of array of bytes.</returns>
        public static PulsarByteString CopyFrom(ByteBuffer buffer) => CopyFrom(buffer.Array, buffer.Offset, buffer.Count);

        /// <summary>
        /// Creates a new <see cref="PulsarByteString"/> by copying a byte array.
        /// </summary>
        /// <param name="array">Array of bytes to copy</param>
        /// <param name="offset">Index in provided <paramref name="array"/>, at which copy should start.</param>
        /// <param name="count">Number of bytes to copy.</param>
        /// <returns>TBD</returns>
        public static PulsarByteString CopyFrom(byte[] array, int offset, int count)
        {
            ...
            return new PulsarByteString(copy, 0, copy.Length);
        }

        /// <summary>
        /// Creates a new <see cref="PulsarByteString"/> by copying segments of bytes.
        /// </summary>
        /// <param name="buffers"></param>
        /// <returns></returns>
        public static PulsarByteString CopyFrom(IEnumerable<ByteBuffer> buffers)
        {
            ...
            return new PulsarByteString(copy, 0, count);
        }

        /// <summary>
        /// Creates a new <see cref="PulsarByteString"/> by wrapping raw array of bytes.
        ...
        /// <returns>TBD</returns>
        public static PulsarByteString FromBytes(byte[] array) => FromBytes(array, 0, array.Length);

        /// <summary>
        /// Creates a new <see cref="PulsarByteString"/> by wrapping raw range over array of bytes. WARNING: 
        ...
        /// <returns>TBD</returns>
        public static PulsarByteString FromBytes(ArraySegment<byte> buffer) =>
        ...
        /// <returns>TBD</returns>
        public static PulsarByteString FromBytes(byte[] array, int offset, int count)
        {
            if (array == null) throw new ArgumentNullException(nameof(array));
            ...
            return new PulsarByteString(array, offset, count);
        }


        /// <summary>
        /// Creates a new <see cref="PulsarByteString"/> by wrapping raw collection of byte segements. 
        /// WARNING: 
        /// this method doesn't copy underlying arrays, but expects that 
        /// represented range should not be modified once attached to byte string.
        /// </summary>
        public static PulsarByteString FromBytes(IEnumerable<ByteBuffer> buffers)
        {
            if (buffers == null) throw new ArgumentNullException(nameof(buffers));
            ...
            return new PulsarByteString(array, count);
        }
        ...
        /// <returns>TBD</returns>
        public static PulsarByteString FromString(string str) => FromString(str, Encoding.UTF8);
        ...
        /// <returns>TBD</returns>
        public static PulsarByteString FromString(string str, Encoding encoding)
        {
        ...
        /// <summary>
        /// An empty <see cref="PulsarByteString"/>.
        /// </summary>
        public static PulsarByteString Empty { get; } = new PulsarByteString(new ByteBuffer(new byte[0], 0, 0));
        ...
        public PulsarByteString(IList<PulsarByteString> buffers)
        {
            _count = buffers.Sum(s => s.Count);
            _buffers = buffers.SelectMany(r => r._buffers).ToArray();
        }

        private PulsarByteString(ByteBuffer[] buffers, int count)
        {
            _buffers = buffers;
            _count = count;
        }

        private PulsarByteString(ByteBuffer buffer)
        {
            _buffers = new[] { buffer };
            _count = buffer.Count;
        }

        private PulsarByteString(byte[] array, int offset, int count)
        {
        ...
        /// <summary>
        /// Gets a total number of bytes stored inside this <see cref="PulsarByteString"/>.
        /// </summary>
        public int Count => _count;

        /// <summary>
        /// Determines if current <see cref="PulsarByteString"/> has compact representation.
        ...
        /// <summary>
        /// Determines if current <see cref="PulsarByteString"/> is empty.
        /// </summary>
        ...
        /// <summary>
        /// Compacts current <see cref="PulsarByteString"/>, potentially copying its content underneat
        /// into new byte array.
        /// </summary>
        /// <returns>TBD</returns>
        public PulsarByteString Compact()
        {
        ...
        /// <summary>
        /// Slices current <see cref="PulsarByteString"/>, creating a new <see cref="PulsarByteString"/>
        /// which contains a specified range of data from the original. This is non-copying
        /// operation.
        /// </summary>
        /// <param name="index">index inside current <see cref="PulsarByteString"/>, from which slicing should start</param>
        public PulsarByteString Slice(int index) => Slice(index, _count - index);
        ...
        /// </summary>
        /// <param name="index">index inside current <see cref="PulsarByteString"/>, from which slicing should start</param>
        /// <param name="count">Number of bytes to fit into new <see cref="PulsarByteString"/>.</param>
        /// <returns></returns>
        public PulsarByteString Slice(int index, int count)
        {
            ...
            return new PulsarByteString(newBuffers, count);
        }

        /// <summary>
        /// Given an <paramref name="index"/> in current <see cref="PulsarByteString"/> tries to 
        ...
        /// from the beginning of the <see cref="PulsarByteString"/>.
        /// </summary>
        /// <param name="b"></param>
        /// <returns></returns>
        ...
        /// <param name="index"></param>
        /// <returns></returns>
        public bool HasSubstring(PulsarByteString other, int index)
        {
        ...
        /// <summary>
        /// Copies content of a current <see cref="PulsarByteString"/> into a single byte array.
        /// </summary>
        /// <returns>TBD</returns>
        public byte[] ToArray()
        {
        ...
        /// <summary>
        /// Appends <paramref name="other"/> <see cref="PulsarByteString"/> at the tail
        /// of a current one, creating a new <see cref="PulsarByteString"/> in result.
        /// Contents of byte strings are NOT copied.
        /// </summary>
        /// <returns>TBD</returns>
        public PulsarByteString Concat(PulsarByteString other)
        {
        ...
        /// <summary>
        /// Copies content of a current <see cref="PulsarByteString"/> into a provided
        ...
        /// <summary>
        /// Copies content of the current <see cref="PulsarByteString"/> to a provided 
        ...
        /// <summary>
        /// Asynchronously copies content of the current <see cref="PulsarByteString"/> 
        ...
        public override bool Equals(object obj) => Equals(obj as PulsarByteString);
        ...
        public bool Equals(PulsarByteString other)
        {
        ...
        public static bool operator ==(PulsarByteString x, PulsarByteString y) => Equals(x, y);

        public static bool operator !=(PulsarByteString x, PulsarByteString y) => !Equals(x, y);

        public static explicit operator PulsarByteString(byte[] bytes) => PulsarByteString.CopyFrom(bytes);

        public static explicit operator byte[](PulsarByteString byteString) => byteString.ToArray();

        public static PulsarByteString operator +(PulsarByteString x, PulsarByteString y) => x.Concat(y);
    }
