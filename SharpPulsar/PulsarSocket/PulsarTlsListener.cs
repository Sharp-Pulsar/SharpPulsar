...
{
    partial class PulsarTlsListener : ActorBase, IRequiresMessageQueue<IUnboundedMessageQueueSemantics>
    {
        ...
        public PulsarTlsListener(TcpExt tcp, IActorRef bindCommander,
            PulsarTcp.Bind bind)
        {
            _tcp = tcp;
        ...
        protected override bool Receive(object message)
        {
            if (message is SocketAsyncEventArgs)
            {
                ...
                if (saea.SocketError == SocketError.Success)
                    Context.ActorOf(Props.Create<PulsarTlsIncomingConnection>(_tcp, saea.AcceptSocket, _bind.Handler, _bind.Options, _bind.PullMode).WithDispatcherIfNeeded(_bind.Options));
