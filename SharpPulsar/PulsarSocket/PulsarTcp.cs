...
namespace SharpPulsar.PulsarSocket
{
    ...
    /// </summary>
    public class PulsarTcp : ExtensionIdProvider<TcpExt>
    {
        /// <summary>
        /// TBD
        /// </summary>
        public static readonly PulsarTcp Instance = new PulsarTcp();
        ...
        /// returns true, the connection actor will reply with the supplied <see cref="Ack" />
        ...
        public class Write : SimpleWriteCommand
        {
            ...
            /// TBD
            /// </summary>
            public static readonly Write Empty = new Write(PulsarByteString.Empty, NoAck.Instance);

            /// <summary>
            /// TBD
            /// </summary>
            public PulsarByteString Data { get; }
            ...
            private Write(PulsarByteString data, Event ack)
            {
            ...
            /// <returns>TBD</returns>
            public static Write Create(PulsarByteString data)
            {
            ...
            /// <returns>TBD</returns>
            public static Write Create(PulsarByteString data, Event ack)
            {
        ...
        */
        ...
        /// you can chain a number of <see cref="Write" /> commands together in a way
        ...
        public sealed class Received : Event
        {
            ...
            /// </summary>
            /// <param name="data">TBD</param>
            public Received(PulsarByteString data)
            {
                Data = data;
            }
    ...
    {
        public TcpExt(ExtendedActorSystem system) : this(system, PulsarTcpSettings.Create(system)) { }

        internal TcpExt(ExtendedActorSystem system, PulsarTcpSettings settings)
        {
        ...
        /// TBD
        /// </summary>
        public PulsarTcpSettings Settings { get; }
    ...
    public class TcpMessage
    {
        ...
        /// <returns>TBD</returns>
        public static PulsarTcp.Command Connect(EndPoint remoteAddress,
            EndPoint localAddress,
            IEnumerable<Inet.SocketOption> options,
            TimeSpan? timeout,
            bool pullMode)
        {
            return new PulsarTcp.Connect(remoteAddress, localAddress, options, timeout, pullMode);
        }
        ...
        /// <param name="pullMode">TBD</param>
        /// <returns>TBD</returns>
        public static PulsarTcp.Command Bind(IActorRef handler,
            EndPoint endpoint,
            int backlog,
            IEnumerable<Inet.SocketOption> options,
            bool pullMode)
        {
            return new PulsarTcp.Bind(handler, endpoint, backlog, options, pullMode);
        }
        ...
        /// <param name="backlog">TBD</param>
        /// <returns>TBD</returns>
        public static PulsarTcp.Command Bind(IActorRef handler, EndPoint endpoint, int backlog)
        {
            return new PulsarTcp.Bind(handler, endpoint, backlog);
        }
        ...
        /// <param name="useResumeWriting">TBD</param>
        /// <returns>TBD</returns>
        public static PulsarTcp.Command Register(IActorRef handler, bool keepOpenOnPeerClosed = false,
            bool useResumeWriting = true)
        {
            return new PulsarTcp.Register(handler, keepOpenOnPeerClosed, useResumeWriting);
        }
        ...
        /// </summary>
        /// <returns>TBD</returns>
        public static PulsarTcp.Command Unbind()
        {
            return PulsarTcp.Unbind.Instance;
        }
        ...
        /// </summary>
        /// <returns>TBD</returns>
        public static PulsarTcp.Command Close()
        {
            return PulsarTcp.Close.Instance;
        }
        ...
        /// </summary>
        /// <returns>TBD</returns>
        public static PulsarTcp.Command ConfirmedClose()
        {
            return PulsarTcp.ConfirmedClose.Instance;
        }
        ...
        /// </summary>
        /// <returns>TBD</returns>
        public static PulsarTcp.Command Abort()
        {
            return PulsarTcp.Abort.Instance;
        }
        ...
        /// <param name="token">TBD</param>
        /// <returns>TBD</returns>
        public static PulsarTcp.NoAck NoAck(object token = null)
        {
            return new PulsarTcp.NoAck(token);
        }
        ...
        /// <param name="ack">TBD</param>
        /// <returns>TBD</returns>
        public static PulsarTcp.Command Write(PulsarByteString data, PulsarTcp.Event ack = null)
        {
            return PulsarTcp.Write.Create(data, ack);
        }
        ...
        /// </summary>
        /// <returns>TBD</returns>
        public static PulsarTcp.Command ResumeWriting()
        {
            return PulsarTcp.ResumeWriting.Instance;
        }
        ...
        /// </summary>
        /// <returns>TBD</returns>
        public static PulsarTcp.Command SuspendReading()
        {
            return PulsarTcp.SuspendReading.Instance;
        }
        ...
        /// </summary>
        /// <returns>TBD</returns>
        public static PulsarTcp.Command ResumeReading()
        {
            return PulsarTcp.ResumeReading.Instance;
        }
        ...
        /// <param name="batchSize">TBD</param>
        /// <returns>TBD</returns>
        public static PulsarTcp.Command ResumeAccepting(int batchSize)
        {
            return new PulsarTcp.ResumeAccepting(batchSize);
        }
    }
    ...
    public static class TcpExtensions
    {
        ...
        /// <param name="system">TBD</param>
        /// <returns>TBD</returns>
        public static IActorRef TcpPulsar(this ActorSystem system)
        {
            return PulsarTcp.Manager(system);
        }
    }
}
