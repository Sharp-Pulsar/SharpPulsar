...
namespace PulsarAdmin
{
    ...
    public static partial class PulsarAdminRESTAPIExtensions
    {
        ...
        public static async Task CreateSubscription1Async(this IPulsarAdminRESTAPI operations, string tenant, string namespaceParameter, string topic, string subscriptionName, string messageId = "latest", bool? replicated = default(bool?), CancellationToken cancellationToken = default(CancellationToken))
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<PostSchemaResponse> PostSchemaAsync(this IPulsarAdminRESTAPI operations, string tenant, string namespaceParameter, string topic, PostSchemaPayload body = default(PostSchemaPayload), bool? authoritative = false, CancellationToken cancellationToken = default(CancellationToken))
            {
