...
namespace PulsarAdmin.Models
{
    ...
    public partial class PublisherStats
    {
        ...
        /// Initializes a new instance of the PublisherStats class.
        /// </summary>
        public PublisherStats(double? msgRateIn = default(double?), double? msgThroughputIn = default(double?), double? averageMsgSize = default(double?), long? producerId = default(long?), IDictionary<string, string> metadata = default(IDictionary<string, string>), string address = default(string), string producerName = default(string), string connectedSince = default(string), string clientVersion = default(string))
        {
            MsgRateIn = msgRateIn;
