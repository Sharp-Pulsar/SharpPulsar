...
namespace SharpPulsar.Akka.InternalCommands
{
    ...
    {
        public BrokerLookUp(string message, bool authoritative, CommandLookupTopicResponse.LookupType response, string brokerServiceUrl, string brokerServiceUrlTls, long requestId)
        {
            Message = message;
