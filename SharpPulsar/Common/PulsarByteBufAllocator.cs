...
namespace SharpPulsar.Common
{
	...
	public class PulsarByteBufAllocator
	{
		...
		private static readonly IList<Action<OutOfMemoryException>> LISTENERS = new List<Action<OutOfMemoryException>>();

		public static void RegisterOOMListener(Action<OutOfMemoryException> listener)
		{
