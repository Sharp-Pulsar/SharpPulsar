...
namespace SharpPulsar.Protocol.Circe
{
	...
	/// </summary>
	public interface StatelessLongHash : StatelessHash
	{
		...
		long Calculate(sbyte[] Input, int Index, int Length);
		...
		/// <returns> the output of the hash function </returns>
		long Calculate(IByteBuffer Input);
