...
{
	public sealed partial class CommandEndTxnOnSubscriptionResponse : ByteBufCodedOutputStream.ByteBufGeneratedMessage
	{
		// Use CommandEndTxnOnSubscriptionResponse.newBuilder() to construct.
		internal static ThreadLocalPool<CommandEndTxnOnSubscriptionResponse> _pool = new ThreadLocalPool<CommandEndTxnOnSubscriptionResponse>(handle => new CommandEndTxnOnSubscriptionResponse(handle), 1, true);

		internal ThreadLocalPool.Handle _handle;
		private CommandEndTxnOnSubscriptionResponse(ThreadLocalPool.Handle handle)
		{
			_handle = handle;
		}
		public void Recycle()
		...
		public CommandEndTxnOnSubscriptionResponse(bool NoInit)
		{
		}


		internal static readonly CommandEndTxnOnSubscriptionResponse _defaultInstance;
		public static CommandEndTxnOnSubscriptionResponse DefaultInstance => _defaultInstance;

        public CommandEndTxnOnSubscriptionResponse DefaultInstanceForType => _defaultInstance;
		...
		{
			// Construct using org.apache.pulsar.common.api.proto.CommandEndTxnOnSubscriptionResponse.newBuilder()
			...
			public CommandEndTxnOnSubscriptionResponse DefaultInstanceForType => DefaultInstance;
			...
			public CommandEndTxnOnSubscriptionResponse BuildParsed()
			{
				CommandEndTxnOnSubscriptionResponse Result = BuildPartial();
			...
			{
				CommandEndTxnOnSubscriptionResponse Result = CommandEndTxnOnSubscriptionResponse._pool.Take();
		...
		{
			_defaultInstance = new CommandEndTxnOnSubscriptionResponse(true);
