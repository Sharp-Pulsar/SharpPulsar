...
{
	public sealed partial class CommandNewTxnResponse : ByteBufCodedOutputStream.ByteBufGeneratedMessage
	{
		// Use CommandNewTxnResponse.newBuilder() to construct.
		internal static ThreadLocalPool<CommandNewTxnResponse> _pool = new ThreadLocalPool<CommandNewTxnResponse>(handle => new CommandNewTxnResponse(handle), 1, true);

		internal ThreadLocalPool.Handle _handle;
		private CommandNewTxnResponse(ThreadLocalPool.Handle handle)
		{
			_handle = handle;
		}
		public void Recycle()
		...
		public CommandNewTxnResponse(bool NoInit)
		{
		}


		internal static readonly CommandNewTxnResponse _defaultInstance;
		public static CommandNewTxnResponse DefaultInstance => _defaultInstance;

        public CommandNewTxnResponse DefaultInstanceForType => _defaultInstance;
		...
		{
			// Construct using org.apache.pulsar.common.api.proto.CommandNewTxnResponse.newBuilder()
			...
			public CommandNewTxnResponse DefaultInstanceForType => CommandNewTxnResponse.DefaultInstance;
			...
			public CommandNewTxnResponse BuildParsed()
			{
				CommandNewTxnResponse Result = BuildPartial();
				if (!Result.Initialized)
				{
			...
			{
				CommandNewTxnResponse Result = CommandNewTxnResponse._pool.Take();
		...
		{
			_defaultInstance = new CommandNewTxnResponse(true);
