...
{
	public sealed partial class CommandEndTxnOnPartitionResponse : ByteBufCodedOutputStream.ByteBufGeneratedMessage
	{
		// Use CommandEndTxnOnPartitionResponse.newBuilder() to construct.
		internal static ThreadLocalPool<CommandEndTxnOnPartitionResponse> _pool = new ThreadLocalPool<CommandEndTxnOnPartitionResponse>(handle => new CommandEndTxnOnPartitionResponse(handle), 1, true);

		internal ThreadLocalPool.Handle _handle;
		private CommandEndTxnOnPartitionResponse(ThreadLocalPool.Handle handle)
		{
			_handle = handle;
		}
		public void Recycle()
		...
		public CommandEndTxnOnPartitionResponse(bool NoInit)
		{
		}

		internal static readonly CommandEndTxnOnPartitionResponse _defaultInstance;
		public static CommandEndTxnOnPartitionResponse DefaultInstance => _defaultInstance;

        public CommandEndTxnOnPartitionResponse DefaultInstanceForType => _defaultInstance;
		...
		{
			// Construct using org.apache.pulsar.common.api.proto.CommandEndTxnOnPartitionResponse.newBuilder()
			...
			public CommandEndTxnOnPartitionResponse DefaultInstanceForType => DefaultInstance;
			...
			public CommandEndTxnOnPartitionResponse BuildParsed()
			{
				CommandEndTxnOnPartitionResponse Result = BuildPartial();
				if (!Result.Initialized)
				{
			...
			{
				CommandEndTxnOnPartitionResponse Result = CommandEndTxnOnPartitionResponse._pool.Take();
		...
		{
			_defaultInstance = new CommandEndTxnOnPartitionResponse(true);
