...
namespace SharpPulsar.Protocol.Proto
{
	public sealed partial class CommandCloseConsumer : ByteBufCodedOutputStream.ByteBufGeneratedMessage
	{
		...
		public static CommandCloseConsumer DefaultInstance => _defaultInstance;

        public CommandCloseConsumer DefaultInstanceForType => _defaultInstance;
		...
		public sealed class Builder : ByteBufMessageBuilder
        {
			...
			public CommandCloseConsumer DefaultInstanceForType => CommandCloseConsumer.DefaultInstance;
