...
{
	public sealed partial class CommandEndTxn : ByteBufCodedOutputStream.ByteBufGeneratedMessage
	{
		// Use CommandEndTxn.newBuilder() to construct.
		internal static ThreadLocalPool<CommandEndTxn> _pool = new ThreadLocalPool<CommandEndTxn>(handle => new CommandEndTxn(handle), 1, true);

		internal ThreadLocalPool.Handle _handle;
		private CommandEndTxn(ThreadLocalPool.Handle handle)
		{
			_handle = handle;
		}
		public void Recycle()
		...
		public CommandEndTxn(bool NoInit)
		{
		}

		//JAVA TO C# CONVERTER NOTE: Fields cannot have the same name as methods:
		internal static readonly CommandEndTxn _defaultInstance;
		public static CommandEndTxn DefaultInstance => _defaultInstance;

        public CommandEndTxn DefaultInstanceForType => _defaultInstance;
		...
		public void WriteTo(ByteBufCodedOutputStream Output)
		{
			...
			{
				Output.WriteEnum(4, (int)TxnAction);
			}
		}
		...
		{
			// Construct using org.apache.pulsar.common.api.proto.CommandEndTxn.newBuilder()
			...
			public CommandEndTxn DefaultInstanceForType => DefaultInstance;
			...
			{
				CommandEndTxn Result = CommandEndTxn._pool.Take();
		...
		{
			_defaultInstance = new CommandEndTxn(true);
