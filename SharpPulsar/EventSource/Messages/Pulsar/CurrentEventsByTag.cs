...
namespace SharpPulsar.EventSource.Messages.Pulsar
{
    ...
    {
        public CurrentEventsByTag(string tenant, string ns, string topic, long fromMessageId, long toMessageId, Tag tag, string adminUrl, ReaderConfigurationData<T> configuration, ClientConfigurationData clientConfiguration)
        {
            Tenant = tenant;
            Namespace = ns;
