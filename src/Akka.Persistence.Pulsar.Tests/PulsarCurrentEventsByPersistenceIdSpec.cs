...
{
    public class PulsarCurrentEventsByPersistenceIdSpec : CurrentEventsByPersistenceIdSpec
    {
        ...
        public PulsarCurrentEventsByPersistenceIdSpec(ITestOutputHelper output) : base(SpecConfig, output: output)
        {
