...
namespace SharpPulsar.Interfaces
{
    ...
    public interface IProducerBuilder<T> : ICloneable
	{
		...
		/// <seealso cref="Producer.getProducerName()"/>.
		/// 
		/// </para>
		...
		/// 
		/// <para>When the queue is full, by default, all calls to <seealso cref="Producer.send"/> and <seealso cref="Producer.sendAsync"/>
		...
		/// <seealso cref="ProducerQueueIsFullError"/> when there is no space left in pending queue. If set to
		/// {@code true}, the <seealso cref="Producer.sendAsync"/> operation will instead block.
		/// 
		/// </para>
		...
		/// <ul>
		/// <li><seealso cref="HashingScheme.JavaStringHash"/>: Java {@code String.hashCode()} (Default)
		...
		/// 
		/// <para>When batching is enabled, multiple calls to <seealso cref="Producer.sendAsync"/> can result in a single batch
		...
		/// 
		/// <para>This feature allows publisher to publish large size of message by splitting it to multiple chunks and let
		...
		/// <seealso cref="ConsumerBuilder.expireTimeOfIncompleteChunkedMessage()"/>
