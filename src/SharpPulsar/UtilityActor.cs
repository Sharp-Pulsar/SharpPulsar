...
{
    public delegate void LogEventHandler(string source, AkkaLogLevel level, object message);
    ...
    public static class UtilityActor
    {
        internal class Logger : ReceiveActor
        {
            public Logger()
            {
                ...
                Receive<LogEvent>(e => Log(e.LogSource, (AkkaLogLevel)e.LogLevel(), e.Message));
            }
        }
        ...
        public static void Log(string source, AkkaLogLevel level, object message)
        {
