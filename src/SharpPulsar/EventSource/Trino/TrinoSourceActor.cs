...
{
    public class TrinoSourceActor : ReceiveActor
    {
        ...
        public TrinoSourceActor(BufferBlock<IEventEnvelope> buffer, bool isLive, ITrinoEventSourceMessage message)
        {
            _buffer = buffer;
            _self = Self;
        ...
        public static Props Prop(BufferBlock<IEventEnvelope> buffer, bool isLive, ITrinoEventSourceMessage message)
        {
            return Props.Create(() => new TrinoSourceActor(buffer, isLive, message));
        }
