...
namespace SharpPulsar.EventSource.Trino.Tagged
{
    public class TrinoTaggedSourceActor : ReceiveActor
    {
        ...
        public TrinoTaggedSourceActor(BufferBlock<IEventEnvelope> buffer, bool isLive, ITrinoEventSourceMessage message, Tag tag)
        {
            _buffer = buffer;
            _tag = tag;
            _self = Self;
        ...
        public static Props Prop(BufferBlock<IEventEnvelope> buffer, bool isLive, ITrinoEventSourceMessage message, Tag tag)
        {
            return Props.Create(() => new TrinoTaggedSourceActor(buffer, isLive, message, tag));
        }
