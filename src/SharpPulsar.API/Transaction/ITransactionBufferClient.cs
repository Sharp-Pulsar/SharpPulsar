...
namespace SharpPulsar.API.Transaction
{
    ...
    public interface ITransactionBufferClient
    {
        ...
        /// <param name="lowWaterMark"> the low water mark of this txn; </param>
        /// <returns> the future represents the commit result </returns>
        ValueTask<TxnID> CommitTxnOnTopic(string topic, long txnIdMostBits, long txnIdLeastBits, long lowWaterMark);
       ...
       ValueTask<TxnID> AbortTxnOnTopic(string topic, long txnIdMostBits, long txnIdLeastBits, long lowWaterMark);
        ...
        /// <param name="lowWaterMark"> the low water mark of this txn </param>
        /// <returns> the future represents the commit result </returns>
        ValueTask<TxnID> CommitTxnOnSubscription(string topic, string subscription, long txnIdMostBits, long txnIdLeastBits, long lowWaterMark);
        ...
        /// <param name="lowWaterMark"> the low water mark of this txn </param>
        /// <returns> the future represents the abort result </returns>
        ValueTask<TxnID> abortTxnOnSubscription(string topic, string subscription, long txnIdMostBits, long txnIdLeastBits, long lowWaterMark);

        void Close();

        int AvailableRequestCredits { get; }
