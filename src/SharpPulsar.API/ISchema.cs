...
namespace SharpPulsar.API
{
	...
	{/// <summary>
	 ...
	 /// <exception cref="SchemaSerializationException"> if it is not a valid message </exception>
        ...
        virtual EncodeData Encode(string topic, T message)
        {
        ...
        /// </summary>
        /// <param name="data">
        ///            the ByteBuffer to decode </param>
        /// <returns> the deserialized object </returns>
        ...
        virtual T Decode(string topic, ByteBuffer data, byte[] schemaId)
        {
            return Decode(data, schemaId);
        }

        virtual T Decode(string topic, byte[] data, byte[] schemaId)
        {
            return Decode(data, schemaId);
        }
		...
		/// </summary>
		public static ISchema<byte[]> Bytes = DefaultImplementation.GetDefaultImplementation.NewBytesSchema();


		/// <summary>
		/// Schema that can be used to encode/decode messages whose values are String. The payload is encoded with UTF-8.
		/// </summary>
		public static ISchema<string> String = DefaultImplementation.GetDefaultImplementation.NewStringSchema();

		/// <summary>
		/// INT8 Schema.
		/// </summary>
		public static ISchema<byte> Int8 = DefaultImplementation.GetDefaultImplementation.NewByteSchema();

		/// <summary>
		/// INT16 Schema.
		/// </summary>
		public static ISchema<short> Int16 = DefaultImplementation.GetDefaultImplementation.NewShortSchema();

		/// <summary>
		/// INT32 Schema.
		/// </summary>
		public static ISchema<int> Int32 = DefaultImplementation.GetDefaultImplementation.NewIntSchema();

		/// <summary>
		/// INT64 Schema.
		/// </summary>
		public static ISchema<long> Int64 = DefaultImplementation.GetDefaultImplementation.NewLongSchema();

		/// <summary>
		/// Boolean Schema.
		/// </summary>
		public static ISchema<bool> Bool = DefaultImplementation.GetDefaultImplementation.NewBoolSchema();

		/// <summary>
		/// Float Schema.
		/// </summary>
		public static ISchema<float> Float = DefaultImplementation.GetDefaultImplementation.NewFloatSchema();

		/// <summary>
		/// Double Schema.
		/// </summary>
		public static ISchema<double> Double = DefaultImplementation.GetDefaultImplementation.NewDoubleSchema();

		/// <summary>
		/// Date Schema.
		/// </summary>
		public static ISchema<DateTime> Date = DefaultImplementation.GetDefaultImplementation.NewDateSchema();
        ...
        /// Instant Schema.
        /// </summary>
        public static ISchema<Instant> Instant = DefaultImplementation.GetDefaultImplementation.NewInstantSchema();
		/// <summary>
		/// LocalDate Schema.
		/// </summary>
		public static ISchema<LocalDate> LocalDate = DefaultImplementation.GetDefaultImplementation.NewLocalDateSchema();
		/// <summary>
		/// LocalTime Schema.
		/// </summary>
		public static ISchema<LocalTime> LocalTime = DefaultImplementation.GetDefaultImplementation.NewLocalTimeSchema();
		/// <summary>
		/// LocalDateTime Schema.
		/// </summary>
		public static ISchema<LocalDateTime> LocalDateTime = DefaultImplementation.GetDefaultImplementation.NewLocalDateTimeSchema();
		...
		{
			return DefaultImplementation.GetDefaultImplementation.NewAvroSchema(ISchemaDefinition<T>.Builder().WithPojo(pojo).Build());
		}
		...
		/// </summary>
		static ISchema<IKeyValue<K, V>> KeyValue<K, V>(Type key, Type value, SchemaType type)
		{
			return DefaultImplementation.GetDefaultImplementation.NewKeyValueSchema<K, V>(key, value, type);
		}

		/// <summary>
		/// Schema that can be used to encode/decode KeyValue.
		/// </summary>
		static ISchema<IKeyValue<byte[], byte[]>> KvBytes()
		{
		...
		/// </summary>
		static ISchema<IKeyValue<K, V>> KeyValue<K, V>(Type key, Type value)
		{
			return DefaultImplementation.GetDefaultImplementation.NewKeyValueSchema<K, V>(key, value, SchemaType.JSON);
		}

		/// <summary>
		/// Key Value Schema using passed in key and value schemas.
		/// </summary>
		static ISchema<IKeyValue<K, V>> KeyValue<K, V>(ISchema<K> key, ISchema<V> value)
		{
			return DefaultImplementation.GetDefaultImplementation.NewKeyValueSchema(key, value, KeyValueEncodingType.INLINE);
		}

		/// <summary>
		/// Key Value Schema using passed in key, value and encoding type schemas.
		/// </summary>
		static ISchema<IKeyValue<K, V>> KeyValue<K, V>(ISchema<K> key, ISchema<V> value, KeyValueEncodingType keyValueEncodingType)
		{
