...
namespace SharpPulsar.Admin.v3.Sinks
{
    using System = global::System;

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.1.0))")]
    public partial interface IPulsarSinkRESTAPIClient
    {
        /// <summary>
        /// Fetches the list of built-in Pulsar IO sinks
        /// </summary>
        /// <returns>Get builtin sinks successfully.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ConnectorDefinition>> GetSinkListAsync();
        ...
        /// <returns>Get builtin sinks successfully.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ConnectorDefinition>> GetSinkListAsync(System.Threading.CancellationToken cancellationToken);

        /// <summary>
        /// Fetches information about config fields associated with the specified builtin sink
        /// </summary>
        /// <param name="name">The name of the builtin sink</param>
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ConfigFieldDefinition>> GetSinkConfigDefinitionAsync(string name);
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ConfigFieldDefinition>> GetSinkConfigDefinitionAsync(string name, System.Threading.CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <param name="tenant">The tenant of a Pulsar Sink</param>
        /// <param name="namespace">The namespace of a Pulsar Sink</param>
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<string> ListSinksAsync(string tenant, string @namespace);
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<string> ListSinksAsync(string tenant, string @namespace, System.Threading.CancellationToken cancellationToken);
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SinkConfig> GetSinkInfoAsync(string tenant, string @namespace, string sinkName);
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SinkConfig> GetSinkInfoAsync(string tenant, string @namespace, string sinkName, System.Threading.CancellationToken cancellationToken);
        ...
        /// <param name="namespace">The namespace of a Pulsar Sink</param>
        /// <param name="sinkName">The name of a Pulsar Sink</param>
        /// <param name="body">You can submit a sink (in any languages that you are familiar with) to a Pulsar cluster. Follow the steps below.
        /// <br/>1. Create a JSON object using some of the following parameters.
        /// <br/>A JSON value presenting config payload of a Pulsar Sink. All available configuration options are:
        /// <br/>- **classname**
        /// <br/>   The class name of a Pulsar Sink if archive is file-url-path (file://)
        /// <br/>- **sourceSubscriptionName**
        /// <br/>   Pulsar source subscription name if user wants a specific
        /// <br/>   subscription-name for input-topic consumer
        /// <br/>- **inputs**
        /// <br/>   The input topic or topics of a Pulsar Sink (specified as a JSON array)
        /// <br/>- **topicsPattern**
        /// <br/>   TopicsPattern to consume from list of topics under a namespace that    match the pattern. [input] and [topicsPattern] are mutually    exclusive. Add SerDe class name for a pattern in customSerdeInputs    (supported for java fun only)- **topicToSerdeClassName**
        /// <br/>   The map of input topics to SerDe class names (specified as a JSON object)
        /// <br/>- **topicToSchemaType**
        /// <br/>   The map of input topics to Schema types or class names (specified as a JSON object)
        /// <br/>- **inputSpecs**
        ...
        /// <br/>- **configs**
        /// <br/>   The map of configs (specified as a JSON object)
        /// <br/>- **secrets**
        /// <br/>   a map of secretName(aka how the secret is going to be 
        /// <br/>   accessed in the function via context) to an object that 
        /// <br/>   encapsulates how the secret is fetched by the underlying 
        /// <br/>   secrets provider. The type of an value here can be found by the 
        /// <br/>   SecretProviderConfigurator.getSecretObjectType() method. (specified as a JSON object)
        /// <br/>- **parallelism**
        /// <br/>   The parallelism factor of a Pulsar Sink (i.e. the number of a Pulsar Sink instances to run 
        /// <br/>- **processingGuarantees**
        /// <br/>   The processing guarantees (aka delivery semantics) applied to the Pulsar Sink. Possible Values: "ATLEAST_ONCE", "ATMOST_ONCE", "EFFECTIVELY_ONCE"
        /// <br/>- **retainOrdering**
        /// <br/>   Boolean denotes whether the Pulsar Sink consumes and processes messages in order
        /// <br/>- **resources**
        /// <br/>   {"cpu": 1, "ram": 2, "disk": 3} The CPU (in cores), RAM (in bytes) and disk (in bytes) that needs to be allocated per Pulsar Sink instance (applicable only to Docker runtime)
        /// <br/>- **autoAck**
        /// <br/>   Boolean denotes whether or not the framework will automatically acknowledge messages
        /// <br/>- **timeoutMs**
        /// <br/>   Long denotes the message timeout in milliseconds
        /// <br/>- **cleanupSubscription**
        /// <br/>   Boolean denotes whether the subscriptions the functions created/used should be deleted when the functions is deleted
        /// <br/>- **runtimeFlags**
        /// <br/>   Any flags that you want to pass to the runtime as a single string
        ...
        /// <param name="namespace">The namespace of a Pulsar Sink</param>
        /// <param name="sinkName">The name of a Pulsar Sink</param>
        /// <param name="bodyBody">A JSON value presenting config payload of a Pulsar Sink. All available configuration options are:
        /// <br/>- **classname**
        /// <br/>   The class name of a Pulsar Sink if archive is file-url-path (file://)
        /// <br/>- **sourceSubscriptionName**
        /// <br/>   Pulsar source subscription name if user wants a specific
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SinkStatus> GetSinkStatusAsync(string tenant, string @namespace, string sinkName);
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SinkStatus> GetSinkStatusAsync(string tenant, string @namespace, string sinkName, System.Threading.CancellationToken cancellationToken);
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SinkInstanceStatusData> GetSinkInstanceStatusAsync(string tenant, string @namespace, string sinkName, string instanceId);
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<SinkInstanceStatusData> GetSinkInstanceStatusAsync(string tenant, string @namespace, string sinkName, string instanceId, System.Threading.CancellationToken cancellationToken);
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.1.0))")]
    public partial class PulsarSinkRESTAPIClient : IPulsarSinkRESTAPIClient
    {
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

        public PulsarSinkRESTAPIClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// <returns>Get builtin sinks successfully.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ConnectorDefinition>> GetSinkListAsync()
        {
            return GetSinkListAsync(System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Get builtin sinks successfully.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ConnectorDefinition>> GetSinkListAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("sinks/builtinsinks");
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ConfigFieldDefinition>> GetSinkConfigDefinitionAsync(string name)
        {
            return GetSinkConfigDefinitionAsync(name, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ConfigFieldDefinition>> GetSinkConfigDefinitionAsync(string name, System.Threading.CancellationToken cancellationToken)
        {
            if (name == null)
                throw new System.ArgumentNullException("name");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("sinks/builtinsinks/{name}/configdefinition");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("builtin sink does not exist", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 500)
                        {
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<string> ListSinksAsync(string tenant, string @namespace)
        {
            return ListSinksAsync(tenant, @namespace, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<string> ListSinksAsync(string tenant, string @namespace, System.Threading.CancellationToken cancellationToken)
        {
            if (tenant == null)
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("sinks/{tenant}/{namespace}");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Invalid list request", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 401)
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("The client is not authorized to perform this operation", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 500)
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Internal server error (failed to authorize, etc.)", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 503)
                        {
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<SinkConfig> GetSinkInfoAsync(string tenant, string @namespace, string sinkName)
        {
            return GetSinkInfoAsync(tenant, @namespace, sinkName, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SinkConfig> GetSinkInfoAsync(string tenant, string @namespace, string sinkName, System.Threading.CancellationToken cancellationToken)
        {
            if (tenant == null)
                throw new System.ArgumentNullException("tenant");
            ...
            if (sinkName == null)
                throw new System.ArgumentNullException("sinkName");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("sinks/{tenant}/{namespace}/{sinkName}");
            urlBuilder_.Replace("{tenant}", System.Uri.EscapeDataString(ConvertToString(tenant, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{namespace}", System.Uri.EscapeDataString(ConvertToString(@namespace, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{sinkName}", System.Uri.EscapeDataString(ConvertToString(sinkName, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<SinkConfig>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("The Pulsar Sink does not exist", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 503)
                        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Invalid request (The Pulsar Sink already exists, etc.)", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 401)
                        {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Internal server error (failed to authorize, failed to get tenant data, failed to process package, etc.)", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 503)
                        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Invalid request (The Pulsar Sink doesn\'t exist, update contains no change, etc.)", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 401)
                        {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("The Pulsar Sink doesn\'t exist", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 500)
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Internal server error (failed to authorize, failed to process package, etc.)", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 503)
                        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Invalid deregister request", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 401)
                        {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Got InterruptedException while deregistering the Pulsar Sink", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 500)
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Internal server error (failed to authorize, failed to deregister, etc.)", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 503)
                        {
        ...
        public virtual async System.Threading.Tasks.Task RestartSinkAsync(string tenant, string @namespace, string sinkName, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("sinks/{tenant}/{namespace}/{sinkName}/restart");
            urlBuilder_.Replace("{tenant}", System.Uri.EscapeDataString(ConvertToString(tenant, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{namespace}", System.Uri.EscapeDataString(ConvertToString(@namespace, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{sinkName}", System.Uri.EscapeDataString(ConvertToString(sinkName, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Internal server error (failed to restart the Pulsar Sink, failed to authorize, etc.)", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 503)
                        {
        ...
        public virtual async System.Threading.Tasks.Task StartSinkAsync(string tenant, string @namespace, string sinkName, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("sinks/{tenant}/{namespace}/{sinkName}/start");
            urlBuilder_.Replace("{tenant}", System.Uri.EscapeDataString(ConvertToString(tenant, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{namespace}", System.Uri.EscapeDataString(ConvertToString(@namespace, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{sinkName}", System.Uri.EscapeDataString(ConvertToString(sinkName, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Invalid start request", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 401)
                        {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Internal server error (failed to start the Pulsar Sink, failed to authorize, etc.)", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 503)
                        {
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<SinkStatus> GetSinkStatusAsync(string tenant, string @namespace, string sinkName)
        {
            return GetSinkStatusAsync(tenant, @namespace, sinkName, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SinkStatus> GetSinkStatusAsync(string tenant, string @namespace, string sinkName, System.Threading.CancellationToken cancellationToken)
        {
            if (tenant == null)
                throw new System.ArgumentNullException("tenant");
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("sinks/{tenant}/{namespace}/{sinkName}/status");
            urlBuilder_.Replace("{tenant}", System.Uri.EscapeDataString(ConvertToString(tenant, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{namespace}", System.Uri.EscapeDataString(ConvertToString(@namespace, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{sinkName}", System.Uri.EscapeDataString(ConvertToString(sinkName, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<SinkStatus>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Current broker doesn\'t serve the namespace of this sink", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 400)
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Invalid get status request", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 401)
                        {
        ...
        public virtual async System.Threading.Tasks.Task StopSinkAsync(string tenant, string @namespace, string sinkName, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("sinks/{tenant}/{namespace}/{sinkName}/stop");
            urlBuilder_.Replace("{tenant}", System.Uri.EscapeDataString(ConvertToString(tenant, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{namespace}", System.Uri.EscapeDataString(ConvertToString(@namespace, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{sinkName}", System.Uri.EscapeDataString(ConvertToString(sinkName, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Invalid stop request", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 401)
                        {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Internal server error (failed to stop the Pulsar Sink, failed to authorize, etc.)", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 503)
                        {
        ...
        public virtual async System.Threading.Tasks.Task RestartSink2Async(string tenant, string @namespace, string sinkName, string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("sinks/{tenant}/{namespace}/{sinkName}/{instanceId}/restart");
            urlBuilder_.Replace("{tenant}", System.Uri.EscapeDataString(ConvertToString(tenant, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{namespace}", System.Uri.EscapeDataString(ConvertToString(@namespace, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{sinkName}", System.Uri.EscapeDataString(ConvertToString(sinkName, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Internal server error (failed to restart the instance of a Pulsar Sink, failed to authorize, etc.)", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 503)
                        {
        ...
        public virtual async System.Threading.Tasks.Task StartSink2Async(string tenant, string @namespace, string sinkName, string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("sinks/{tenant}/{namespace}/{sinkName}/{instanceId}/start");
            urlBuilder_.Replace("{tenant}", System.Uri.EscapeDataString(ConvertToString(tenant, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{namespace}", System.Uri.EscapeDataString(ConvertToString(@namespace, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{sinkName}", System.Uri.EscapeDataString(ConvertToString(sinkName, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{instanceId}", System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<SinkInstanceStatusData> GetSinkInstanceStatusAsync(string tenant, string @namespace, string sinkName, string instanceId)
        {
            return GetSinkInstanceStatusAsync(tenant, @namespace, sinkName, instanceId, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>successful operation</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SinkInstanceStatusData> GetSinkInstanceStatusAsync(string tenant, string @namespace, string sinkName, string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            if (tenant == null)
                throw new System.ArgumentNullException("tenant");
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("sinks/{tenant}/{namespace}/{sinkName}/{instanceId}/status");
            urlBuilder_.Replace("{tenant}", System.Uri.EscapeDataString(ConvertToString(tenant, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{namespace}", System.Uri.EscapeDataString(ConvertToString(@namespace, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{sinkName}", System.Uri.EscapeDataString(ConvertToString(sinkName, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{instanceId}", System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<SinkInstanceStatusData>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("The Pulsar Sink instance does not exist", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 404)
                        {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Internal Server Error (got exception while getting status, etc.)", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 503)
                        {
        ...
        public virtual async System.Threading.Tasks.Task StopSink2Async(string tenant, string @namespace, string sinkName, string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("sinks/{tenant}/{namespace}/{sinkName}/{instanceId}/stop");
            urlBuilder_.Replace("{tenant}", System.Uri.EscapeDataString(ConvertToString(tenant, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{namespace}", System.Uri.EscapeDataString(ConvertToString(@namespace, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{sinkName}", System.Uri.EscapeDataString(ConvertToString(sinkName, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{instanceId}", System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial class SinkConfig
    {
        ...
        [Newtonsoft.Json.JsonProperty("sourceSubscriptionName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SourceSubscriptionName { get; set; }

        [Newtonsoft.Json.JsonProperty("sourceSubscriptionPosition", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public SinkConfigSourceSubscriptionPosition? SourceSubscriptionPosition { get; set; }
        ...
        [Newtonsoft.Json.JsonProperty("topicToSerdeClassName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.IDictionary<string, string> TopicToSerdeClassName { get; set; }
        ...
        [Newtonsoft.Json.JsonProperty("topicToSchemaType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.IDictionary<string, string> TopicToSchemaType { get; set; }

        [Newtonsoft.Json.JsonProperty("topicToSchemaProperties", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.IDictionary<string, string> TopicToSchemaProperties { get; set; }
        ...
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public SinkConfigProcessingGuarantees? ProcessingGuarantees { get; set; }
        ...
        [Newtonsoft.Json.JsonProperty("negativeAckRedeliveryDelayMs", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public long? NegativeAckRedeliveryDelayMs { get; set; }

        [Newtonsoft.Json.JsonProperty("sinkType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("transformFunction", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string TransformFunction { get; set; }

        [Newtonsoft.Json.JsonProperty("transformFunctionClassName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string TransformFunctionClassName { get; set; }

        [Newtonsoft.Json.JsonProperty("transformFunctionConfig", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string TransformFunctionConfig { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.1.0))")]
    public partial class SinkInstanceStatus
    {
        ...
        public SinkInstanceStatusData Status { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.1.0))")]
    public partial class SinkInstanceStatusData
    {
        ...
        [Newtonsoft.Json.JsonProperty("numReadFromPulsar", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public long? NumReadFromPulsar { get; set; }
        ...
        [Newtonsoft.Json.JsonProperty("numSinkExceptions", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public long? NumSinkExceptions { get; set; }

        [Newtonsoft.Json.JsonProperty("latestSinkExceptions", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<ExceptionInformation> LatestSinkExceptions { get; set; }

        [Newtonsoft.Json.JsonProperty("numWrittenToSink", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public long? NumWrittenToSink { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.1.0))")]
    public partial class SinkStatus
    {
        ...
        public System.Collections.Generic.ICollection<SinkInstanceStatus> Instances { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.1.0))")]
    public enum SinkConfigSourceSubscriptionPosition
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.1.0))")]
    public enum SinkConfigProcessingGuarantees
    {
