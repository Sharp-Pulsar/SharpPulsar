...
namespace SharpPulsar.Admin.v3.Transactions
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.1.0))")]
    public partial class PulsarTransactionsRESTAPIClient : IPulsarTransactionsRESTAPIClient
    {
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

        public PulsarTransactionsRESTAPIClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        public virtual async System.Threading.Tasks.Task GetCoordinatorInternalStatsAsync(bool? authoritative, string coordinatorId, bool? metadata, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append("transactions/coordinatorInternalStats/{coordinatorId}?");
            urlBuilder_.Replace("{coordinatorId}", System.Uri.EscapeDataString(ConvertToString(coordinatorId, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Transaction coordinator not found", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 405)
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Broker don\'t use MLTransactionMetadataStore!", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 409)
                        {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("This Broker is not configured with transactionCoordinatorEnabled=true.", status_, responseText_, headers_, null);
                        }
                        else
        ...
        public virtual async System.Threading.Tasks.Task GetCoordinatorStatsAsync(bool? authoritative, int? coordinatorId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (coordinatorId != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("coordinatorId") + "=").Append(System.Uri.EscapeDataString(ConvertToString(coordinatorId, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
        ...
        public virtual async System.Threading.Tasks.Task GetPendingAckInternalStatsAsync(bool? authoritative, string tenant, string @namespace, string topic, string subName, bool? metadata, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("transactions/pendingAckInternalStats/{tenant}/{namespace}/{topic}/{subName}?");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Topic is not owned by this broker!", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 400)
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Topic is not a persistent topic!", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 403)
                        {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Tenant or cluster or namespace or topic or subscription name doesn\'t exist", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 405)
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Pending ack handle don\'t use managedLedger!", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 409)
                        {
        ...
        public virtual async System.Threading.Tasks.Task GetPendingAckStatsAsync(bool? authoritative, string tenant, string @namespace, string topic, string subName, bool? lowWaterMarks, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("transactions/pendingAckStats/{tenant}/{namespace}/{topic}/{subName}?");
            urlBuilder_.Replace("{tenant}", System.Uri.EscapeDataString(ConvertToString(tenant, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{namespace}", System.Uri.EscapeDataString(ConvertToString(@namespace, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{topic}", System.Uri.EscapeDataString(ConvertToString(topic, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{subName}", System.Uri.EscapeDataString(ConvertToString(subName, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            if (lowWaterMarks != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("lowWaterMarks") + "=").Append(System.Uri.EscapeDataString(ConvertToString(lowWaterMarks, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Tenant or cluster or namespace or topic or subName doesn\'t exist", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 409)
                        {
        ...
        public virtual async System.Threading.Tasks.Task GetPositionStatsInPendingAckAsync(bool? authoritative, string tenant, string @namespace, string topic, string subName, long ledgerId, long entryId, int? batchIndex, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("transactions/positionStatsInPendingAck/{tenant}/{namespace}/{topic}/{subName}/{ledgerId}/{entryId}?");
            urlBuilder_.Replace("{tenant}", System.Uri.EscapeDataString(ConvertToString(tenant, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{namespace}", System.Uri.EscapeDataString(ConvertToString(@namespace, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{topic}", System.Uri.EscapeDataString(ConvertToString(topic, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{subName}", System.Uri.EscapeDataString(ConvertToString(subName, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            if (batchIndex != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("batchIndex") + "=").Append(System.Uri.EscapeDataString(ConvertToString(batchIndex, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
        ...
        public virtual async System.Threading.Tasks.Task GetSlowTransactionsAsync(bool? authoritative, string timeout, int? coordinatorId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("transactions/slowTransactions/{timeout}?");
            urlBuilder_.Replace("{timeout}", System.Uri.EscapeDataString(ConvertToString(timeout, System.Globalization.CultureInfo.InvariantCulture)));
            if (authoritative != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("authoritative") + "=").Append(System.Uri.EscapeDataString(ConvertToString(authoritative, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Topic don\'t owner by this broker!", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 400)
                        {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("Tenant or cluster or namespace or topic or coordinator or transaction doesn\'t exist", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 409)
                        {
        ...
        public virtual async System.Threading.Tasks.Task GetTransactionBufferStatsAsync(bool? authoritative, string tenant, string @namespace, string topic, bool? lowWaterMarks, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("transactions/transactionBufferStats/{tenant}/{namespace}/{topic}?");
            urlBuilder_.Replace("{tenant}", System.Uri.EscapeDataString(ConvertToString(tenant, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{namespace}", System.Uri.EscapeDataString(ConvertToString(@namespace, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{topic}", System.Uri.EscapeDataString(ConvertToString(topic, System.Globalization.CultureInfo.InvariantCulture)));
            if (authoritative != null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("The number of replicas should be more than the current number of transaction coordinator replicas", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 503)
                        {
        ...
        public virtual async System.Threading.Tasks.Task GetTransactionInBufferStatsAsync(bool? authoritative, string tenant, string @namespace, string topic, string mostSigBits, string leastSigBits, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (leastSigBits == null)
                throw new System.ArgumentNullException("leastSigBits");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("transactions/transactionInBufferStats/{tenant}/{namespace}/{topic}/{mostSigBits}/{leastSigBits}?");
            urlBuilder_.Replace("{tenant}", System.Uri.EscapeDataString(ConvertToString(tenant, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{namespace}", System.Uri.EscapeDataString(ConvertToString(@namespace, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{topic}", System.Uri.EscapeDataString(ConvertToString(topic, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{mostSigBits}", System.Uri.EscapeDataString(ConvertToString(mostSigBits, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{leastSigBits}", System.Uri.EscapeDataString(ConvertToString(leastSigBits, System.Globalization.CultureInfo.InvariantCulture)));
            if (authoritative != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("authoritative") + "=").Append(System.Uri.EscapeDataString(ConvertToString(authoritative, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
        ...
        public virtual async System.Threading.Tasks.Task GetTransactionInPendingAckStatsAsync(bool? authoritative, string tenant, string @namespace, string topic, string mostSigBits, string leastSigBits, string subName, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("transactions/transactionInPendingAckStats/{tenant}/{namespace}/{topic}/{subName}/{mostSigBits}/{leastSigBits}?");
            urlBuilder_.Replace("{tenant}", System.Uri.EscapeDataString(ConvertToString(tenant, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{namespace}", System.Uri.EscapeDataString(ConvertToString(@namespace, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{topic}", System.Uri.EscapeDataString(ConvertToString(topic, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{mostSigBits}", System.Uri.EscapeDataString(ConvertToString(mostSigBits, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task GetTransactionMetadataAsync(bool? authoritative, string mostSigBits, string leastSigBits, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("transactions/transactionMetadata/{mostSigBits}/{leastSigBits}?");
            urlBuilder_.Replace("{mostSigBits}", System.Uri.EscapeDataString(ConvertToString(mostSigBits, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{leastSigBits}", System.Uri.EscapeDataString(ConvertToString(leastSigBits, System.Globalization.CultureInfo.InvariantCulture)));
            if (authoritative != null)
            {
