...
namespace Org.Apache.Pulsar.Common.Policies.Data
{
	...
	{
		ISet<string> AdminRoles {get;}

		ISet<string> AllowedClusters {get;}
	...
	public interface TenantInfoBuilder
	{
		TenantInfoBuilder AdminRoles(ISet<string> adminRoles);
		TenantInfoBuilder AllowedClusters(ISet<string> allowedClusters);
		TenantInfo Build();
	}
