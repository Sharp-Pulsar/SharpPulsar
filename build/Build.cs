    ...
    Target Pack => _ => _
      ...
      .Executes(() =>
      {
          ...
          DotNetPack(s => s
              ...
              .EnableNoBuild()
              .EnableNoRestore()
              .SetAssemblyVersion($"2.2.1")
              .SetVersion($"2.2.1")
              .SetPackageReleaseNotes($"[MAINTENANCE]{Environment.NewLine}Updated AvroSchemaGenerator to 2.1.0 which has a fix for dictionary mismatch exception")
    ...
    Target PackBeta => _ => _
      ...
      .Executes(() =>
      {
          ...
          DotNetPack(s => s
              ...
              .EnableNoBuild()
              .EnableNoRestore()
              .SetAssemblyVersion($"2.2.1.beta")
              .SetVersionPrefix("2.2.1")
              .SetPackageReleaseNotes($"[MAINTENANCE]{Environment.NewLine}Updated AvroSchemaGenerator to 2.1.0 which has a fix for dictionary mismatch exception")
