    ...
    Target PackSql => _ => _
        ...
        .Executes(() =>
        {
            ...
            DotNetPack(s => s
                ...
                .EnableNoBuild()
                .EnableNoRestore()
                .SetAssemblyVersion($"2.0.1.{BuildNumber}")
                .SetVersion($"2.0.1.{BuildNumber}")
                .SetPackageReleaseNotes("BREAKING CHANGES. Huge changes to the public API and Made AskResponse internal to avoid conflicts")
