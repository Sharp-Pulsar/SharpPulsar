...
namespace Samples
{
    public class Program
    {
            ...
            while (true)
            {
                ...
                switch (cmd)
                {
                    ...
                    case "74":
                        ...
                        tenant = Console.ReadLine();
                        Console.WriteLine("[EventsByTopicReader] Enter Namespace: ");
                        ns = Console.ReadLine();
                        Console.WriteLine("[EventsByTopicReader] Enter Topic: ");
                        topic = Console.ReadLine();
                        Console.WriteLine("[EventsByTopicReader] Enter FromSequence: ");
                        fro = long.Parse(Console.ReadLine());
                        Console.WriteLine("[EventsByTopicReader] Enter ToSequence: ");
                        to = long.Parse(Console.ReadLine());
                        Console.WriteLine("[EventsByTopicReader] Enter admin Url: ");
                        adminUrl = Console.ReadLine();
                        EventsByTopicReader(pulsarSystem, tenant, ns, topic, fro, to, adminUrl);
                        break;
                    case "75":
                        Console.WriteLine("[CurrentEventsByTopicReader] Enter Tenant: ");
                        tenant = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTopicReader] Enter Namespace: ");
                        ns = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTopicReader] Enter Topic: ");
                        topic = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTopicReader] Enter FromSequence: ");
                        fro = long.Parse(Console.ReadLine());
                        Console.WriteLine("[CurrentEventsByTopicReader] Enter ToSequence: ");
                        to = long.Parse(Console.ReadLine());
                        Console.WriteLine("[CurrentEventsByTopicReader] Enter admin Url: ");
                        adminUrl = Console.ReadLine();
                        CurrentEventsByTopicReader(pulsarSystem, tenant, ns, topic, fro, to, adminUrl);
                        break;
                    case "79":
                        Console.WriteLine("[EventsByTagReader] Enter Tenant: ");
                        tenant = Console.ReadLine();
                        Console.WriteLine("[EventsByTagReader] Enter Namespace: ");
                        ns = Console.ReadLine();
                        Console.WriteLine("[EventsByTagReader] Enter Topic: ");
                        topic = Console.ReadLine();
                        Console.WriteLine("[EventsByTagReader] Enter FromSequence: ");
                        fro = long.Parse(Console.ReadLine());
                        Console.WriteLine("[EventsByTagReader] Enter ToSequence: ");
                        to = long.Parse(Console.ReadLine());
                        Console.WriteLine("[EventsByTagReader] Enter admin Url: ");
                        adminUrl = Console.ReadLine();
                        Console.WriteLine("[EventsByTagReader] Enter Tag key: ");
                        key = Console.ReadLine();
                        Console.WriteLine("[EventsByTagReader] Enter Tag value: ");
                        value = Console.ReadLine();
                        EventsByTagReader(pulsarSystem, tenant, ns, topic, fro, to, adminUrl, key, value);
                        break;
                    case "80":
                        Console.WriteLine("[CurrentEventsByTagReader] Enter Tenant: ");
                        tenant = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTagReader] Enter Namespace: ");
                        ns = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTagReader] Enter Topic: ");
                        topic = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTagReader] Enter FromSequence: ");
                        fro = long.Parse(Console.ReadLine());
                        Console.WriteLine("[CurrentEventsByTagReader] Enter ToSequence: ");
                        to = long.Parse(Console.ReadLine());
                        Console.WriteLine("[CurrentEventsByTagReader] Enter admin Url: ");
                        adminUrl = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTagReader] Enter Tag key: ");
                        key = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTagReader] Enter Tag value: ");
                        value = Console.ReadLine();
                        CurrentEventsByTagReader(pulsarSystem, tenant, ns, topic, fro, to, adminUrl, key, value);
                        break;
                    case "81":
                        Console.WriteLine("[EventsByTopicPresto] Enter Tenant: ");
                        tenant = Console.ReadLine();
                        Console.WriteLine("[EventsByTopicPresto] Enter Namespace: ");
                        ns = Console.ReadLine();
                        Console.WriteLine("[EventsByTopicPresto] Enter Topic: ");
                        topic = Console.ReadLine();
                        Console.WriteLine("[EventsByTopicPresto] Enter FromSequence: ");
                        fro = long.Parse(Console.ReadLine());
                        Console.WriteLine("[EventsByTopicPresto] Enter ToSequence: ");
                        to = long.Parse(Console.ReadLine());
                        Console.WriteLine("[EventsByTopicPresto] Enter pulsar admin Url: ");
                        adminUrl = Console.ReadLine();
                        Console.WriteLine("[EventsByTopicPresto] Enter presto server address: ");
                        server = Console.ReadLine();
                        Console.WriteLine("[EventsByTopicPresto] Enter selection columns in coma delimited format(age,gender): ");
                        columns = Console.ReadLine();
                        EventsByTopicPresto(pulsarSystem, tenant, ns, topic, fro, to, adminUrl, server, columns);
                        break;
                    case "82":
                        Console.WriteLine("[CurrentEventsByTopicPresto] Enter Tenant: ");
                        tenant = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTopicPresto] Enter Namespace: ");
                        ns = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTopicPresto] Enter Topic: ");
                        topic = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTopicPresto] Enter FromSequence: ");
                        fro = long.Parse(Console.ReadLine());
                        Console.WriteLine("[CurrentEventsByTopicPresto] Enter ToSequence: ");
                        to = long.Parse(Console.ReadLine());
                        Console.WriteLine("[CurrentEventsByTopicPresto] Enter pulsar admin Url: ");
                        adminUrl = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTopicPresto] Enter presto server address: ");
                        server = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTopicPresto] Enter selection columns in coma delimited format(age,gender): ");
                        columns = Console.ReadLine();
                        CurrentEventsByTopicPresto(pulsarSystem, tenant, ns, topic, fro, to, adminUrl, server, columns);
                        break;
                    case "83":
                        Console.WriteLine("[EventsByTagPresto] Enter Tenant: ");
                        tenant = Console.ReadLine();
                        Console.WriteLine("[EventsByTagPresto] Enter Namespace: ");
                        ns = Console.ReadLine();
                        Console.WriteLine("[EventsByTagPresto] Enter Topic: ");
                        topic = Console.ReadLine();
                        Console.WriteLine("[EventsByTagPresto] Enter FromSequence: ");
                        fro = long.Parse(Console.ReadLine());
                        Console.WriteLine("[EventsByTagPresto] Enter ToSequence: ");
                        to = long.Parse(Console.ReadLine());
                        Console.WriteLine("[EventsByTagPresto] Enter pulsar admin Url: ");
                        adminUrl = Console.ReadLine();
                        Console.WriteLine("[EventsByTagPresto] Enter presto server address: ");
                        server = Console.ReadLine();
                        Console.WriteLine("[EventsByTagPresto] Enter selection columns in coma delimited format(age,gender): ");
                        columns = Console.ReadLine();
                        Console.WriteLine("[EventsByTagPresto] Enter Tag key: ");
                        key = Console.ReadLine();
                        Console.WriteLine("[EventsByTagPresto] Enter Tag value: ");
                        value = Console.ReadLine();
                        EventsByTagPresto(pulsarSystem, tenant, ns, topic, fro, to, adminUrl, server, columns, key, value);
                        break;
                    case "84":
                        Console.WriteLine("[CurrentEventsByTagPresto] Enter Tenant: ");
                        tenant = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTagPresto] Enter Namespace: ");
                        ns = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTagPresto] Enter Topic: ");
                        topic = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTagPresto] Enter FromSequence: ");
                        fro = long.Parse(Console.ReadLine());
                        Console.WriteLine("[CurrentEventsByTagPresto] Enter ToSequence: ");
                        to = long.Parse(Console.ReadLine());
                        Console.WriteLine("[CurrentEventsByTagPresto] Enter pulsar admin Url: ");
                        adminUrl = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTagPresto] Enter presto server address: ");
                        server = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTagPresto] Enter selection columns in coma delimited format(age,gender): ");
                        columns = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTagPresto] Enter Tag key: ");
                        key = Console.ReadLine();
                        Console.WriteLine("[CurrentEventsByTagPresto] Enter Tag value: ");
                        value = Console.ReadLine();
                        CurrentEventsByTagPresto(pulsarSystem, tenant, ns, topic, fro, to, adminUrl, server, columns, key, value);
                        break;
        ...
        private static void SendMessages(PulsarSystem system, string topic, IActorRef producer, string key, string value, bool tag)
        {
            ...
            var ids =  system.BulkSend(bulk, producer);
        ...
        private static void PlainByteBulkSendProducer(PulsarSystem system, string topic)
        {
            ...
            var bulk = new BulkSend(sends, topic);
            var ids = system.BulkSend(bulk, t.Producer);
            foreach (var id in ids)
            {
                Console.WriteLine(JsonSerializer.Serialize(id));
            }
        ...
        {
            var e = system.PulsarAdmin<GetAllVersionsSchemaResponse>(new Admin(AdminCommands.GetAllSchemas, new object[]{ tenant, ns, topic, false}, null, e=> Console.WriteLine(e.ToString()), server, l=> Console.WriteLine(l)));
        ...
        private static void RegisterSchema(PulsarSystem system, string server, string tenant, string ns, string topic)
        {
            ...
            var e = system.PulsarAdmin<PostSchemaResponse>(new Admin(AdminCommands.PostSchema, new object[]{ tenant, ns, topic,
                new PostSchemaPayload("avro", schema, new Dictionary<string, string>{{ "__alwaysAllowNull", "true" }, { "__jsr310ConversionEnabled", "false" } }), false}, null, e=> Console.WriteLine(e.ToString()), server, Console.WriteLine));
            var data = JsonSerializer.Serialize(e, new JsonSerializerOptions { WriteIndented = true });
            Console.WriteLine(data);
        }
        ...
        {
            var e = system.PulsarAdmin<IList<string>>(new Admin(AdminCommands.GetTenants, new object[] { }, null, e => Console.WriteLine(e.ToString()), server, Console.WriteLine));
            var data = JsonSerializer.Serialize(e, new JsonSerializerOptions { WriteIndented = true });
            Console.WriteLine(data);
        }
        ...
        {
            var e = system.PulsarAdmin<PersistencePolicies>(new Admin(AdminCommands.GetPersistence, new object[] { "events", "akka", "ALL"}, e =>
            {
            }, e => Console.WriteLine(e.ToString()), server, Console.WriteLine));
        ...
        {
            var e = system.PulsarAdmin<IList<string>>(new Admin(AdminCommands.GetList, new object[] { "events", "akka", "ALL"}, e =>
            {
            }, e => Console.WriteLine(e.ToString()), server, Console.WriteLine));
            var data = JsonConvert.SerializeObject(e, Formatting.Indented);
            Console.WriteLine(data);
        ...
        {
            var e = system.PulsarAdmin<IList<string>>(new Admin(AdminCommands.GetTenantNamespaces, new object[] { "whitepurple", "akka", "ALL"}, e =>
            {
                var data = JsonConvert.SerializeObject(e, Formatting.Indented);
                Console.WriteLine(data);
            }, e => Console.WriteLine(e.ToString()), server, Console.WriteLine));
        ...
        {
           var e = system.PulsarAdmin<IList<string>>(new Admin(AdminCommands.GetPartitionedTopicList, new object[] { "events", "akka", "ALL"}, e =>
            {
            }, e => Console.WriteLine(e.ToString()), server, Console.WriteLine));
           var data = JsonConvert.SerializeObject(e, Formatting.Indented);
           Console.WriteLine(data);
        ...
        {
            var e = system.PulsarAdmin<RetentionPolicies>(new Admin(AdminCommands.GetRetention, new object[] { tenant, ns}, e =>
            {
            }, e => Console.WriteLine(e.ToString()), server, Console.WriteLine));
            var data = JsonConvert.SerializeObject(e, Formatting.Indented);
            Console.WriteLine(data);
        ...
        {
            var e = system.PulsarAdmin<object>(new Admin(AdminCommands.GetTopics2, new object[] { "events", "akka", "ALL" }, e =>
            {
            }, e => Console.WriteLine(e.ToString()), server, Console.WriteLine));
            var data = JsonConvert.SerializeObject(e, Formatting.Indented);
            Console.WriteLine(data);
        ...
        {
            var e =system.PulsarAdmin<IList<string>>(new Admin(AdminCommands.GetListPersistence, new object[] { "public", "default", "ALL" }, e =>
            {
            }, e => Console.WriteLine(e.ToString()), server, Console.WriteLine));
            var data = JsonConvert.SerializeObject(e, Formatting.Indented);
            Console.WriteLine(data);
        ...
        {
            var e = system.PulsarAdmin<string>(new Admin(AdminCommands.GetSchemaCompatibilityStrategy, new object[] { tenant, ns}, e =>
            {
            }, e => Console.WriteLine(e.ToString()), server, Console.WriteLine));
            Console.WriteLine(e);
        }
        ...
        {
            var e = system.PulsarFunction<FunctionConfig>(new Function(FunctionCommand.GetFunctionInfo, new object[]
            {
                "public",
                "default",
                "Covid19-function",
        ...
        {
            var e = system.PulsarFunction<FunctionStatus>(new Function(FunctionCommand.GetFunctionStatus, new object[]
            {
                "public",
                "default",
                "Covid19-function",
        ...
        {
            var e = system.PulsarFunction<FunctionStats>(new Function(FunctionCommand.GetFunctionStats, new object[]
            {
                "public",
                "default",
                "Covid19-function",
        ...
        {
            var e = system.PulsarFunction<string>(new Function(FunctionCommand.ListFunctions, new object[]
            {
                "public",
                "default"
            }, e =>
