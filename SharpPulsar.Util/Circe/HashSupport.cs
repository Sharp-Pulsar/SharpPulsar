...
namespace SharpPulsar.Util.Circe
{
	...
	public sealed class HashSupport
	{
		...
		public static int Compare(ISet<HashSupport> set1, ISet<HashSupport> set2)
		{
			...
			IEnumerator<HashSupport> i1 = set1.GetEnumerator();
			IEnumerator<HashSupport> i2 = set2.GetEnumerator();
			int floor = MinPriority;
		...
		/// <summary>
		/// <seealso cref="System.Collections.IComparer"/> for <seealso cref="EnumSet EnumSets"/> for hash support flags.
		/// </summary>
		static static class SetComparator : IComparer<ISet<HashSupport>>
		{
