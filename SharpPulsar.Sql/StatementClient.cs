...
namespace SharpPulsar.Sql
{
	...
	public interface StatementClient : System.IDisposable
	{
		string Query {get;}
		...
		Optional<string> SetCatalog {get;}

		Optional<string> SetSchema {get;}
...
//ORIGINAL LINE: @Nullable String getStartedTransactionId();
