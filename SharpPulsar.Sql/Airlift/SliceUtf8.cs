 ...
 */
namespace SharpPulsar.Sql.Airlift
{
	...
	public sealed class SliceUtf8
	{
		...
		{
			ParameterCondition.CheckArgument(codePointStart >= 0, "codePointStart is negative");
            ParameterCondition.CheckArgument(codePointLength >= 0, "codePointLength is negative");
